...
| automodelImage | object | This object has the following default values for the NeMo Customizer AutoModel microservice image. | NeMo Customizer image that supports training for HuggingFace models using NeMo AutoModel |
| automodelImage.imagePullPolicy | string | `"IfNotPresent"` | Image pull policy for the NeMo Customizer AutoModel image. |
| automodelImage.registry | string | `"nvcr.io"` | Registry for the NeMo Customizer AutoModel image. |
| automodelImage.repository | string | `"nvidia/nemo-microservices/customizer-automodel"` | Repository for the NeMo Customizer AutoModel image. |
...
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB" | object | This object has the following default values for the Llama 3.2 3B Instruct model. | Llama 3.2 3B Instruct model configuration. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".max_seq_length | int | `4096` | The largest context used for training. Datasets are truncated based on the maximum sequence length. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".name | string | `"llama-3.2-3b-instruct@v1.0.0+80GB"` | The name for training config template. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".namespace | string | `"meta"` | The namespace for training config template. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".prompt_template | string | `"{prompt} {completion}"` | Prompt template used to extract keys from the dataset. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".target | string | `"meta/llama-3.2-3b-instruct@2.0"` | The target to perform the customization on. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options | list | `[{"finetuning_type":"lora","micro_batch_size":1,"num_gpus":1,"num_nodes":1,"tensor_parallel_size":1,"training_type":"sft"},{"finetuning_type":"all_weights","micro_batch_size":1,"num_gpus":2,"num_nodes":1,"tensor_parallel_size":1,"training_type":"distillation"}]` | Resource configuration for each training option for the target model. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0] | object | `{"finetuning_type":"lora","micro_batch_size":1,"num_gpus":1,"num_nodes":1,"tensor_parallel_size":1,"training_type":"sft"}` | Training method. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0].finetuning_type | string | `"lora"` | The type of fine-tuning method. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0].micro_batch_size | int | `1` | The number of training examples processed in parallel by each individual GPU. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0].num_gpus | int | `1` | The number of GPUs per node to use for the specified training. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0].num_nodes | int | `1` | The number of nodes to use for the specified training. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[0].tensor_parallel_size | int | `1` | The number of GPUs among which the model’s tensors are partitioned. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1] | object | `{"finetuning_type":"all_weights","micro_batch_size":1,"num_gpus":2,"num_nodes":1,"tensor_parallel_size":1,"training_type":"distillation"}` | Training method.1 |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1].finetuning_type | string | `"all_weights"` | The type of fine-tuning method. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1].micro_batch_size | int | `1` | The number of training examples processed in parallel by each individual GPU. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1].num_gpus | int | `2` | The number of GPUs per node to use for the specified training. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1].num_nodes | int | `1` | The number of nodes to use for the specified training. |
| customizationConfigTemplates.templates."meta/llama-3.2-3b-instruct@v1.0.0+80GB".training_options[1].tensor_parallel_size | int | `1` | The number of GPUs among which the model’s tensors are partitioned. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB" | object | This object has the following default values for the NVIDIA nemotron-nano-9b-v2 model. | NVIDIA Nemotron-Nano-V2 9b model configuration. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".max_seq_length | int | `4096` | The largest context used for training. Datasets are truncated based on the maximum sequence length. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".name | string | `"nemotron-nano-9b-v2@v1.0.0+80GB"` | The name for training config template. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".namespace | string | `"nvidia"` | The namespace for training config template. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".prompt_template | string | `"{prompt} {completion}"` | Prompt template used to extract keys from the dataset. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".target | string | `"nvidia/nemotron-nano-9b-v2@v1"` | The target to perform the customization on. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options | list | `[{"finetuning_type":"all_weights","micro_batch_size":1,"num_gpus":8,"num_nodes":1,"pipeline_parallel_size":1,"tensor_parallel_size":1,"training_type":"sft"}]` | Resource configuration for each training option for the target model. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0] | object | `{"finetuning_type":"all_weights","micro_batch_size":1,"num_gpus":8,"num_nodes":1,"pipeline_parallel_size":1,"tensor_parallel_size":1,"training_type":"sft"}` | Training method. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].finetuning_type | string | `"all_weights"` | The type of fine-tuning method. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].micro_batch_size | int | `1` | The number of training examples processed in parallel by each individual GPU. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].num_gpus | int | `8` | The number of GPUs per node to use for the specified training. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].num_nodes | int | `1` | The number of nodes to use for the specified training. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].pipeline_parallel_size | int | `1` | The number of GPUs among which the model’s layers are distributed. |
| customizationConfigTemplates.templates."nvidia/nemotron-nano-9b-v2@v1.0.0+80GB".training_options[0].tensor_parallel_size | int | `1` | The number of GPUs among which the model’s tensors are partitioned. |
...
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1 | object | This object has the following default values for the nvidia/nemotron-nano-9b-v2 model. | nvidia/nemotron-nano-9b-v2 target model configuration. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.base_model | string | `"nvidia/nemotron-nano-9b-v2"` | Mapping to the model name to the optimized llama embedding training script and NIM |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.enabled | bool | `false` | Whether to enable the model. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.hf_endpoint | string | `"https://huggingface.co"` | HF endpoint |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.model_path | string | `"nemotron_nano_9b_v2"` | Path where model files are stored. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.model_uri | string | `"hf://nvidia/NVIDIA-Nemotron-Nano-9B-v2"` | HF model URI |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.name | string | `"nemotron-nano-9b-v2@v1"` | The name for target model. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.namespace | string | `"nvidia"` | The namespace for target model. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.num_parameters | int | `9000000000` | Number of model parameters. |
| customizationTargets.targets.nvidia/nemotron-nano-9b-v2@v1.precision | string | `"bf16-mixed"` | Model precision format. |
...
| nemoRlImage.imagePullPolicy | string | `"IfNotPresent"` | Image pull policy for the NeMo Customizer training image used for alignment. |
| nemoRlImage.registry | string | `"nvcr.io"` | Registry for the NeMo Customizer training image used for alignment. |
| nemoRlImage.repository | string | `"nvidia/nemo-microservices/customizer-rl"` | Repository for the NeMo Customizer training image used for alignment. |

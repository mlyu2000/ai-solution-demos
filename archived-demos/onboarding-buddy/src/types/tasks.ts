...
export interface TaskTemplate {
  ...
  createdByRole: 'admin' | 'manager' | 'mentor' | 'new-hire';
  createdAt: Date;
}
...
export interface TaskContextType {
  ...
  addTaskTemplate: (template: Omit<TaskTemplate, "id" | "createdAt" | "createdByRole">, userId: string, userRole?: 'admin' | 'manager' | 'mentor' | 'new-hire') => void;
  ...
  getReviewableTasks: (mentorId: string, users: any[], taskReviews?: any[]) => PersonalizedTask[];
